...
<b>The partnership between UC Davis, Royal University of Agriculture (RUA), and University of Battambang (UBB) builds on a USAID project aiming to develop and cultivate a safe vegetable value chain (SVVC) within Cambodia to ease food security issues. </b><br>
